...
public class ImageManager {
    ...
    public static Bitmap HERO_IMAGE_HARD;
    public static Bitmap HERO_IMAGE_NORMAL;
    ...
    public static void initImage(Context context){
        ...
        ImageManager.BACKGROUND_IMAGE_SIMPLE = BitmapFactory.decodeResource(context.getResources(), R.drawable.bg);
        ImageManager.BACKGROUND_IMAGE_NORMAL = BitmapFactory.decodeResource(context.getResources(), R.drawable.bg_normal);
        ImageManager.BACKGROUND_IMAGE_HARD = BitmapFactory.decodeResource(context.getResources(), R.drawable.bg_hard);

        ImageManager.HERO_IMAGE = BitmapFactory.decodeResource(context.getResources(), R.drawable.hero);
        ImageManager.HERO_IMAGE_NORMAL = BitmapFactory.decodeResource(context.getResources(), R.drawable.hero_normal1);
        ImageManager.HERO_IMAGE_HARD = BitmapFactory.decodeResource(context.getResources(), R.drawable.hero_hard);
        ...
        ImageManager.BOSS_BULLET_IMAGE = BitmapFactory.decodeResource(context.getResources(), R.drawable.bullet_enemy);
        ...
        CLASSNAME_IMAGE_MAP.put(HeroAircraft.class.getName(), HERO_IMAGE_NORMAL);
        CLASSNAME_IMAGE_MAP.put(HeroAircraft.class.getName(), HERO_IMAGE_HARD);
        ...
        CLASSNAME_IMAGE_MAP.put(HpProp.class.getName(), HP_SUPPLY_IMAGE);
